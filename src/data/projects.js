...
export const projects = [
  {
    ...
    problem:
      "Detecting CO₂ at 4.26 µm needs an emitter bright enough to be useful, built on a III-V material system nobody had a working etch process for. The material and the process had to be solved together, or neither was worth solving.",
    description:
    ...
    outcome:
      "A 9× brighter emitter than the bulk baseline, and a repeatable etch process for AlGaInSb that everything downstream depended on. Ran alongside a commercial sensing partner rather than in isolation.",
    tags: [
  ...
  },
  {
    ...
    problem:
      "Optical coherence tomography steers its beam mechanically, which caps speed and adds a part that wears out. Moving the scanner onto a chip means solving beam steering, calibration and control at once — a photonics problem, a PCB problem and a software problem in one.",
    description:
    ...
    outcome:
      "1.7° beamwidth across a 20° steering range from a 16-element array, with calibration automated rather than done by hand — the difference between a demo and something another group can actually use.",
    tags: [
  ...
  },
  {
    ...
    problem:
      "A satellite-borne synthetic aperture radar needed beamforming a conventional RF payload could not deliver inside its mass and bandwidth budget — and no single photonic platform offered every function the receiver required.",
    description:
    ...
    outcome:
      "A hybrid SiN + InP assembly that put each function on the platform suited to it, with the analog link budget validated end to end before the module went into space compliance testing.",
    tags: [
      "Microwave Photonics",
      "Beamforming",
      "SiN",
  ...
  },
  {
    ...
    problem:
      "A multi-static radar constellation only works if every satellite shares a coherent reference — an optical, RF and free-space problem simultaneously. The chosen SOI platform had no on-chip optical gain to carry it.",
    description:
    ...
    outcome:
      "Micro-transfer-printed amplifiers added the gain the platform lacked, on a multi-project PIC carrying generation, distribution and down-conversion on one die.",
    tags: [
      "Silicon Photonics",
  ...
  },
  {
    ...
    problem:
      "Multiband RF transceiver and wideband signal-processing functions for defense-funded European programmes, delivered alongside major industry partners.",
    description:
  ...
  },
  {
    ...
    problem:
      "Automotive-grade LiDAR has to be solid state, which means steering the beam on a chip. Phase shifters, antennas and couplers all have to work together before there is a system to test at all.",
    description:
    ...
    outcome:
      "Multiple device architectures designed, taped out and validated, feeding the first functional end-to-end FMCW LiDAR demonstrator.",
  ...
  },
  {
    ...
    problem:
      "A photonic platform is worth nothing until other people can design on it. That means a PDK, validated devices, and shared workflows across a dozen organisations that had none in common.",
    description:
