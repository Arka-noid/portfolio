...
export const publications = [
  {
    title:
      `Micro-Transfer Printed Continuous-Wave and Mode-Locked Laser Integration at 800 nm on a
  ...
  {
    title:
      `Silicon Photonic FMCW LiDAR with Integrated High-Speed Line-Scan Illumination and 2D
        Coherent Receivers`,
  ...
  {
    title:
      `High-Performance Silicon Optical Phase Shifter Targeting Large-Scale Programmable
        Photonic Circuits`,
  ...
  {
    title:
      `A Tunable Optical 90° Hybrid Coupler in SOI for Wavelength-Independent Coherent
        Receivers`,
  ...
  {
    title:
      `Scalable Butt-Coupled Integration of 800 nm Lasers on Silicon Nitride Using
  ...
  {
    title:
      `Photonic Integrated Filter in Silicon Nitride Technology for High-Performance Microwave
  ...
  {
    title:
      `Design, Fabrication, and Characterization of a Hybrid Integrated Photonic Module for a
  ...
  {
    title:
      `Electro-Optic Packaging of Silicon Photonics-Based RF Multiplier for Clock Signal
        Generation in the Millimeter-Wave Band`,
  ...
  {
    title:
      `Towards System-on-Chip Integration of Photonic-Based Coherent Distributed Synthetic
        Aperture Radar`,
  ...
  {
    title:
      `Silicon-on-Insulator Microwave Photonic Filter With Widely Tunable and Reconfigurable
        Flat-Top Bandpass Functionality`,
  ...
  {
    title:
      `Multi-Static Multi-Band Synthetic Aperture Radar (SAR) Constellation Based on Integrated
        Photonic Circuits`,
  ...
  {
    title:
      `Design and Performance Estimation of a Photonic Integrated Beamforming Receiver for
        Scan-On-Receive Synthetic Aperture Radar`,
  ...
  {
    title:
      `Advancement of Photonic Integration Technology for Space Applications: A X-Band
        Scan-On-Receive Synthetic Aperture Radar Receiver with Electro-Photonic Beamforming`,
  ...
  {
    title:
      `Design of an Integrated-Photonics RF Beamformer for Multi-Beam Satellite Synthetic
        Aperture Radar`,
  ...
  {
    title:
      `Development of AlGaInSb/GaInSb Multi-Quantum Well Light Emitting Diodes for CO₂
        Detection at 4.26 μm`,
  ...
  {
    title:
      `Development of AlGaInSb Multi Quantum-Well Light Emitting Diodes in the 3–5 μm Spectral
        Range`,
    authors: "M. Reza, A. Sheridan, B. Roycroft, B.M. Corbett et al.",
  ...
  {
    title:
      `Etching Process for Producing Various Sloping Sidewall of III-V Antimonide-Based
        Materials for LED/PD Applications`,
    authors: "M. Reza, A. Sheridan, B. Roycroft, B.M. Corbett et al.",
  ...
  {
    title:
      `Mid-Infrared Rotated Image Singly Resonant Twisted Rectangle Optical Parametric
        Oscillator Based on HgGa₂S₄ Pumped at 1064 nm`,
  ...
  {
    title:
      `Optical Damage Studies of Mercury Thiogallate Nonlinear Crystals for Use in 1-μm Pumped
  ...
  {
    title:
      `Optical Damage Limits in Chalcogenide Nonlinear Crystals Used in 1064 nm Pumped
