...
| `/about` | `pages/AboutPage.jsx` — About + RecordTeaser + Publications, as sections on one page |
| `/profile` | `pages/ProfilePage.jsx` — the employment record (`Experience`) on its own page; deliberately not in the nav |
