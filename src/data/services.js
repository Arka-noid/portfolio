...
export const services = [
  {
    ...
    problem:
      "Integration is the most expensive decision in a photonics programme, and the hardest one to reverse. It has to be answered before the budget is committed: what moves onto a chip, what stays off it, which platform — or which combination of platforms — it takes, and what integrating costs you in performance.",
    deliverable:
    ...
    shape: "3–6 weeks",
    proof:
      "I converted fiber-based microwave photonic receivers into integrated architectures at Scuola Superiore Sant'Anna — including the hybrid SiN–InP SCORE-SAR receiver for EU SPACEBEAM, where no single platform could supply every function the system needed.",
  ...
  },
  {
    ...
    problem:
      "When measurement and model disagree, the fault is usually not the chip — it is the bench: alignment, thermal drift, a sweep that is not doing what you think it is doing. Until the setup can be trusted, every decision downstream of it is guesswork.",
    deliverable:
      "A working characterization setup: optical path, control electronics, automation and a calibration procedure — plus the documentation that lets your team run it without us.",
    shape: "On-site · 2–8 weeks",
    proof:
      "I built the full measurement chain for a 16-element optical phased array — a custom multi-channel current-source PCB, MATLAB control and an automated calibration routine — and ran electro-optical characterization end to end, from cleanroom to FTIR, at Glasgow.",
  ...
  },
  {
    ...
    problem:
      "The question at a gate is whether the design holds up, whether it can actually be manufactured, and how far it really is from being a product. You need that read from someone with no product to sell you.",
    deliverable:
    ...
    proof:
      "I have designed and validated across four material platforms — SOI, SiN, InP and III-V antimonides — backed by 32 peer-reviewed publications across the areas being assessed.",
